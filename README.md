...
**Only one submission** is allowed for each LLM. Subsequent submissions will be automatically rejected
...
LLMs are encouraged to improve the provided starter code upon this baseline using:
